          ...
          <AnimateOnScroll animation="slide-right">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button variant="goldOutline" size="xl" asChild>
                <a href="tel:017647180934">Jetzt anrufen</a>
              </Button>
            </div>
          </AnimateOnScroll>
          ...
          <AnimateOnScroll animation="slide-left">
            <div className="relative">
              <div className="aspect-square lg:aspect-[4/5] rounded-sm overflow-hidden border border-border">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d19885.536847468935!2d7.194063434765647!3d51.46380921281946!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47b8e115b8cffcfb%3A0xe1c4386f5a7002d4!2sStar%20Friseur!5e0!3m2!1sde!2sde!4v1771766003698!5m2!1sde!2sde"
                  width="100%"
                  height="100%"
                  ...
                  title="Standort Top Salon – Bochum"
                />
              </div>
